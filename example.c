...
void game_begin() {
    // Load sound
    song = al_load_sample( "sounds/bgm.wav" );
    if (!song){
    ...
    font2 = al_load_ttf_font("font/pirulen.ttf",18,0);
    font3 = al_load_ttf_font("font/pirulen.ttf",28,0);
    font4 = al_load_ttf_font("font/Roboto-Light.ttf",12,0);
    character1.life=10;
    character2.life=10;
    ...
    if(window == 1){
       ...
       if (!al_is_event_queue_empty(event_queue)) {
            ...
            if(judge_about_window){
                window=4;
                image=al_load_bitmap("images/girl.png");
            }
            ...
            if(judge_start_window) {
                ...
                character2.x = 550;
                character2.y = 330;
                image1 = al_load_bitmap("images/normal.png");
                character_z.image_path = al_load_bitmap("images/bold_white_punch.png");
                character_x.image_path = al_load_bitmap("images/bold_white_kick.png");
                character_c.image_path = al_load_bitmap("images/bold_white_dazhao.png");
                image2= al_load_bitmap("images/reverse.png");
                character_b.image_path=al_load_bitmap("images/bold_white_punch_reverse.png");
                character_n.image_path=al_load_bitmap("images/bold_white_kick_reverse.png");
                character_m.image_path=al_load_bitmap("images/bold_white_dazhao_reverse.png");
                background = al_load_bitmap("images/stage_0.jpg");
